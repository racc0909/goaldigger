...
st.markdown(
    f"""
    <h1>Recommended Investment Options for Medium Risk and Long Term</h1>
    """,
...
st.markdown(
    f"""
    <h2 class="custom-subheader">Based on your <u>medium</u> risk tolerance and preference for <u>long-term</u> investments, we recommend the following options:</h2>
    """,
    unsafe_allow_html=True
)
